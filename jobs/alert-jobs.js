...
const iplAlertService = require('../alerts/ipl-alert-service');
...
const IPL_SERVICE_CRON = process.env.IPL_SERVICE_CRON;
...
var iplAlertJob = new CronJob(IPL_SERVICE_CRON, async function() {
  await iplAlertService.alert();
}, null, false, 'Asia/Kolkata');
...
module.exports = { alertServiceJob, priceChangeJob, dailyGamesJob, iplAlertJob, vaccineAlertJob }